...
class SiteConfigView(LoginRequiredMixin, View):
    ...
    template_name = "coreapp/siteconfig.html"
...
class SessionCreateView(LoginRequiredMixin, SuccessMessageMixin, CreateView):
     ...
     template_name = "coreapp/mgtform.html"
     success_url = reverse_lazy("sessions")
     success_message = "New Session Added Successfully"
...
class SessionUpdateView(LoginRequiredMixin, SuccessMessageMixin, UpdateView):
       ...
       def form_valid(self, form):
            ...
            if obj.current == False:
                 ...
                 if not terms:
                      messages.warning(self.request, "The session Must Be Set To Current")
...
class SessionDeleteView(LoginRequiredMixin, DeleteView):
     model = AcademicSession
     success_url = reverse_lazy("sessions")
     template_name = "coreapp/core_confirm_delete.html"
     success_message = "This session {} has been deleted with all its content"

     def delete(self, request, *args, **kwargs):
          obj = self.get_object()
          if obj.current == True:
               messages.warning(request, "Cannot delete this session as it is set to current")
